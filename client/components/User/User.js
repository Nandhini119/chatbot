          ...
          <nav className="navbar navbar-inverse navbar-fixed-top" style = {styles.appbar}>
            <div className="container-fluid">
              ...
              <div className="collapse navbar-collapse" id="myNavbar">
                ...
                <li><a className="bookmark"><Bookmark  style={styles.title}/></a></li>
                  <li><a  style = {styles.title}><span><Avatar  color = "white" size = {30} backgroundColor = "purple" onClick={this.handlePopover}>U</Avatar></span> User</a></li>
